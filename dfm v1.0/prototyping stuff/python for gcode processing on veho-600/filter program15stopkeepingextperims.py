...
def remove_small_extrusion_segments(lines, output_file, extrusion_threshold, start, end):
    ...
    if segment_lines and total_extrusion >= extrusion_threshold or retain_segment_override == 1:
        ...
        retain_segment_override = 0
    result_lines = start+result_lines
...
# Parameters
extrusion_threshold = 2  # Threshold for total extrusion length
input_file = "secondary moddedforv-series-1mmnozzle-regularjayowhitepetgsplit8.gcode"  # Input G-code file
output_file = "f15_"+str(extrusion_threshold)+input_file  # Output G-code file
