...
input_file = "secondary moddedforv-series-1mmnozzle-hsjayopetgagain9.gcode"  # Input G-code file
output_file = "f14_"+str(extrusion_threshold)+input_file  # Output G-code file
